...
<div class="min-h-[70vh] flex items-center justify-center px-5">
    <div class="text-center max-w-md">
        <p class="font-serif text-[clamp(5rem,15vw,10rem)] text-[#C8A96E]/10 leading-none select-none">404</p>
        <div class="-mt-6 mb-6">
            <span class="text-5xl">🍃</span>
        </div>
        <h1 class="font-serif font-light text-3xl text-[#EDE0CC] mb-3">Página não encontrada</h1>
        <p class="text-[#7A8E72] text-sm leading-relaxed mb-8">
            Parece que essa folha caiu do galho. O endereço que você buscou não existe ou foi movido.
        </p>
