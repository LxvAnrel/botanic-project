...
@section('content')
<div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-10 py-8 md:py-12">
    <div class="mb-8 md:mb-10 border-b border-white/[0.06] pb-6 md:pb-8">
        <p class="text-[9px] uppercase tracking-[0.5em] text-[#7A8E72] mb-3">— Coleção Botânica</p>
        <h1 class="font-serif font-light text-3xl md:text-5xl text-[#EDE0CC] mb-2">Catálogo de Plantas</h1>
